...
let ChatbotModule = ChatbotModule_1 = class ChatbotModule {
    static register(config) {
        return {
            module: ChatbotModule_1,
            providers: [
                {
                    provide: tokens_1.CHATBOT_CONFIG,
                    useValue: config,
                },
            ],
            exports: [tokens_1.CHATBOT_CONFIG],
        };
    }
};
exports.ChatbotModule = ChatbotModule;
exports.ChatbotModule = ChatbotModule = ChatbotModule_1 = __decorate([
    (0, common_1.Module)({
        providers: [
            {
        ...
        exports: [tokens_1.AI_PROVIDER, chat_completions_service_1.ChatCompletionsService, chatbot_assistant_service_1.ChatbotAssistantService, tokens_1.CHATBOT_CONFIG],
    })
], ChatbotModule);
